...
#define counter_ticks_to_ns(dev, ticks) ({ 	uint64_t retval; 	sys_port_trace_syscall_enter(K_SYSCALL_COUNTER_TICKS_TO_NS, counter_ticks_to_ns, dev, ticks); 	retval = counter_ticks_to_ns(dev, ticks); 	sys_port_trace_syscall_exit(K_SYSCALL_COUNTER_TICKS_TO_NS, counter_ticks_to_ns, dev, ticks, retval); 	retval; })
#endif
#endif
